...
- (void)viewDidLoad
{
    ...
    */
    NSURL *url = [NSURL URLWithString:@"https://api.weibo.com/oauth2/authorize?client_id=364262043&redirect_uri=http://www.baidu.com"];
...
//    mgr.responseSerializer = [AFJSONResponseSerializer serializer];
    ...
    params[@"client_id"] = @"364262043";
    params[@"client_secret"] = @"c842526ad16793c755a4ac27393fa8c8";
